...
def do_train(sess, args):
  ...
  with tf.device('/cpu:0'):
    ...
    dnn_model= model(images_ph, labels_ph, utils.loss, optimizer, wd, args.architecture, args.depth, args.num_classes, is_training_ph, args.transfer_mode, num_gpus= args.num_gpus, top_n=args.top_n)
...
def do_evaluate(sess, args):
  with tf.device('/cpu:0'):
    ...
    dnn_model= model(images_ph, labels_ph, utils.loss, None, 0.0, args.architecture, args.depth, args.num_classes, is_training_ph, args.transfer_mode, top_n=args.top_n)
